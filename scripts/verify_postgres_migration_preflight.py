...
RUNTIME_MARKERS = (
    ...
    "V38__Add_character_life_states.sql",
    "V38 character life table is missing",
    "v38_character_life_schema=passed",
    "V39__Add_character_memories.sql",
    "V39 character memory table is missing",
    "v39_character_memory_schema=passed",
    "V40__Add_character_relationship_states.sql",
    "V40 character relationship table is missing",
    "v40_character_relationship_schema=passed",
    "V3[0-5]__",
